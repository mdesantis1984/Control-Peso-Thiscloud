...
- Estado global: 🔵 **PLANIFICADO** — Fase 0 ⏳ | Fase 1 ⏳ | Fase 2 ⏳ | Fase 3 ⏳ | Fase 4 ⏳ | Fase 5 ⏳ | Fase 6 ⏳ | Fase 7 ⏳ | Fase 8 ⏳ (0/52 tareas = **0%** ejecutado)
...
Tareas:
- P3.1 Crear ServiceCollectionExtensions para registro DI (DbContext, servicios).
- P3.2 Implementar seed data para desarrollo (usuarios demo + registros de peso).
- P3.3 Tests de integración con SQLite in-memory.
...
|------:|:----:|-------|---:|:------|
| P0.1  | 0 | Crear solución + 4 proyectos | 0% | ⏳ |
| P0.2  | 0 | Crear 3 proyectos de test | 0% | ⏳ |
| P0.3  | 0 | Referencias entre proyectos (Onion) | 0% | ⏳ |
| P0.4  | 0 | CPM + Directory.Build.props | 0% | ⏳ |
| P0.5  | 0 | MudBlazor + tema oscuro base | 0% | ⏳ |
| P0.6  | 0 | .editorconfig + .gitignore + README | 0% | ⏳ |
| P0.7  | 0 | CI básico | 0% | ⏳ |
